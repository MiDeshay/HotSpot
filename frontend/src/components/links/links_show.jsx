      ...
      <div className="links-div">
        ...
        <div className="links-body">
          <div className="links-list">
            <LinksItemContainer name="Michael Deshay" github="https://github.com/MiDeshay" linkedin="https://www.linkedin.com/in/michael-deshay-a76472220/" title="Team Lead" description="" imageClassName="mugshot-michael" img="../images/mugshot_michael.jpg"/>
